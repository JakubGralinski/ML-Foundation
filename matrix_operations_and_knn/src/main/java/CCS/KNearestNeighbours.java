...
public class KNearestNeighbours {
    ...
    // Sort the indices of the training dataset according to distance from the observation.
    public int[] sortDistances(double[] observation) {
        ...
        // Simple selection sort based on the distances.
        for (int i = 0; i < n - 1; i++) {
            for (int j = i + 1; j < n; j++) {
    ...
    // If there is a tie, randomly pick one of the top classes.
